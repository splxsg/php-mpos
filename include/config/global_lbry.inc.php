...
$config['wallet']['username'] = 'lbryuser';
$config['wallet']['password'] = 'lbrypassword123';
 ...
 **/
$config['gettingstarted']['coinname'] = 'Lbrycoin';
$config['gettingstarted']['coinurl'] = 'https://lbry.io/';
$config['gettingstarted']['stratumurl'] = '';
$config['gettingstarted']['stratumport'] = '3008';
