 ...
 */
$config['DEBUG'] = 0;
$config['SALT'] = 'PLEASEMAKEMESOMdsafsadfETHINGRANDOM';
$config['SALTY'] = 'THISSHOULDALSOBERRAANNsadfsadfsDDOOM';
...
$config['wallet']['host'] = 'localhost:10456';
$config['wallet']['username'] = 'litecoinserver';
$config['wallet']['password'] = 'litecoinserver123';
 ...
 **/
$config['swiftmailer']['type'] = '';
$config['swiftmailer']['sendmail']['path'] = '';
$config['swiftmailer']['sendmail']['options'] = '';
$config['swiftmailer']['smtp']['host'] = '';
$config['swiftmailer']['smtp']['port'] = '';
$config['swiftmailer']['smtp']['encryption'] = '';
 ...
 **/
$config['gettingstarted']['coinname'] = 'Zcoin';
$config['gettingstarted']['coinurl'] = 'https://zcoin.io';
$config['gettingstarted']['stratumurl'] = '';
$config['gettingstarted']['stratumport'] = '3010';
 ...
 */
$config['confirmations'] = 101;
$config['network_confirmations'] = 101;
...
$config['memcache']['expiration'] = 300;
